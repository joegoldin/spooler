...
function SpoolList({ title, onEdit, onDelete, onSort, onArchive, onEditHistory, onDeleteHistory, spools }) {
  ...
  const handleEditHistoryClick = (spoolId, historyEntry) => {
    ...
    setEditedHistoryEntry({ used_amount: historyEntry.used_amount, note: historyEntry.note });
  };
  ...
  const handleHistoryInputChange = (field, value) => {
    setEditedHistoryEntry(prev => ({ ...prev, [field]: value }));
  };

  // ... rest of the SpoolList component ...
